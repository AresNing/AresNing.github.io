...
本篇 18 项检查执行于 2026-09-14；所有上游源码仍固定在 2026-09-12 的提交。历史实验未重跑。完整版本及归档哈希见 [versions.json](versions.json)。
...
- [client-recovery-diagram-validation.json](client-recovery-diagram-validation.json)
- [client-recovery-mechanism-results.json](client-recovery-mechanism-results.json)
- [client-recovery-module-sources.json](client-recovery-module-sources.json)
- [client-recovery-reproduction.json](client-recovery-reproduction.json)
- [client-recovery-results.json](client-recovery-results.json)
