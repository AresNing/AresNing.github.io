...
原记录日期：2026-09-12 至 13 日。本次于 2026-09-14 核对附件和正文，没有重跑历史机制实验，仅复跑查看器9项检查。完整版本及归档哈希见 [versions.json](versions.json)。
...
- [clients-results.json](clients-results.json)
...
- [trace-viewer.html](trace-viewer.html)
