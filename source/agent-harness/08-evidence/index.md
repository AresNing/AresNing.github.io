...
[返回 08 正文](/agent-harness/08-subagents/) · [下载完整材料](/downloads/agent-harness/08/agent-harness-08.zip)

原记录日期：2026-09-12 至 13 日。本次于 2026-09-14 核对附件和正文，没有重新执行实验。完整版本及归档哈希见 [versions.json](/downloads/agent-harness/08/content/evidence/versions.json)。
...
- [subagent-extraction.json](/downloads/agent-harness/08/content/evidence/subagent-extraction.json)
- [subagent-results.json](/downloads/agent-harness/08/content/evidence/subagent-results.json)
...
[复现入口](/agent-harness/08-reproduce/)
