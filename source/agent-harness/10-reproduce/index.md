...
本目录提供正文引用的实验源码与原始结果，记录来自 2026-09-12 至 13 日，本次润色未重跑。范围见[本篇实验说明](/agent-harness/10-evidence/)。包内没有上游源码或依赖。
...
```sh
node experiments/observability-build.mjs
node experiments/observability-lab.mjs
python3 experiments/mechanism_lab.py
```
