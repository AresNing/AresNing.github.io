...
[返回 10 正文](/agent-harness/10-observability/) · [下载完整材料](/downloads/agent-harness/10/agent-harness-10.zip)

原记录日期：2026-09-12 至 13 日。本次于 2026-09-14 核对附件和正文，没有重新执行实验。完整版本及归档哈希见 [versions.json](/downloads/agent-harness/10/content/evidence/versions.json)。
...
- [mechanism-results.json](/downloads/agent-harness/10/content/evidence/mechanism-results.json)
- [observability-results.json](/downloads/agent-harness/10/content/evidence/observability-results.json)
...
[复现入口](/agent-harness/10-reproduce/)
